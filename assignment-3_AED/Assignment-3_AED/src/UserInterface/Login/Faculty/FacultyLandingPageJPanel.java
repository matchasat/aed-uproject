...
public class FacultyLandingPageJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        profSpecTable.setBackground(new java.awt.Color(0, 255, 255));
        ...
        createCourseBtn.setBackground(new java.awt.Color(0, 0, 0));
        createCourseBtn.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        createCourseBtn.setForeground(new java.awt.Color(255, 0, 0));
        ...
        editCourseBtn.setBackground(new java.awt.Color(0, 0, 0));
        editCourseBtn.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        editCourseBtn.setForeground(new java.awt.Color(255, 0, 0));
        ...
        backBtn.setForeground(new java.awt.Color(0, 255, 51));
        ...
        refreshBtn.setForeground(new java.awt.Color(0, 255, 51));
        ...
        btnViewProfileDetails.setBackground(new java.awt.Color(0, 0, 0));
        btnViewProfileDetails.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnViewProfileDetails.setForeground(new java.awt.Color(255, 0, 0));
