...
public class EditCourseJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtCourseId.setBackground(new java.awt.Color(0, 255, 51));
        add(txtCourseId, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 150, 147, -1));

        txtCourseName.setBackground(new java.awt.Color(0, 255, 51));
        txtCourseName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCourseNameActionPerformed(evt);
            }
        });
        add(txtCourseName, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, 147, -1));

        txtRegion.setBackground(new java.awt.Color(0, 255, 51));
        add(txtRegion, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 240, 147, -1));

        txtLanguage.setBackground(new java.awt.Color(0, 255, 51));
        txtLanguage.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtLanguageActionPerformed(evt);
            }
        });
        add(txtLanguage, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 280, 147, -1));
