...
public class CourseRegisterJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        courseIdTextArea.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        courseIdTextArea.setForeground(new java.awt.Color(0, 102, 102));
        add(courseIdTextArea, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 140, 146, -1));

        courseNameTextArea.setEditable(false);
        courseNameTextArea.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        courseNameTextArea.setForeground(new java.awt.Color(0, 102, 102));
        ...
        facultyNameTextArea.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        facultyNameTextArea.setForeground(new java.awt.Color(0, 102, 102));
        ...
        langTextArea.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        langTextArea.setForeground(new java.awt.Color(0, 102, 102));
