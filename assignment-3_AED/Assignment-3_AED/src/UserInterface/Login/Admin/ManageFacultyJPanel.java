...
public class ManageFacultyJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        createFacultyBtn.setBackground(new java.awt.Color(51, 255, 204));
        createFacultyBtn.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        facultyIdTextField.setBackground(new java.awt.Color(0, 102, 51));
        ...
        searchBtn.setBackground(new java.awt.Color(153, 255, 204));
        ...
        hideInOutPanel.setBackground(new java.awt.Color(0, 255, 51));
